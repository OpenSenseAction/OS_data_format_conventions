...
|tsl_min (cml_id,sublink_id, time)

|float/double| units = dBm| coordinates = string_with_auxiliary_coordinate_variable_names, long_name = "minimum_transmitted_signal_level_over_time_window", missing_value| Optional| 
